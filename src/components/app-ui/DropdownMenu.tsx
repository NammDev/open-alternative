...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cx(
      "!m-0 rounded !px-2 !py-1.5",
      "focus:bg-card-dark focus:text-foreground focus:outline-none",
