...
import { VariantProps, cva, cx } from "@/lib/cva";
  ...
  return (
    <div className={cx(introVariants({ alignment, className }))} {...props}>
      <Series size="lg" className="relative w-full">
        ...
        <div className="pointer-events-none absolute inset-x-0 -bottom-2 h-8 select-none bg-gradient-to-t from-background/40 to-transparent" />
      </Series>
